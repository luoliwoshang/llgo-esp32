# export PATH="/Users/zhangzhiyang/Documents/Code/temp/tinygo/llvm-build/bin:$PATH"
 export PATH="/Users/zhangzhiyang/.espressif/tools/esp-clang/esp-18.1.2_20240912/esp-clang/bin:$PATH" && llgo build -target esp32-coreboard-v2 -tags nogc -o test /Users/zhangzhiyang/Documents/Code/goplus/llgo-esp32/independant-llgo-esp/main.go
# Convert ELF to BIN
...
python /Users/zhangzhiyang/esp/esp-idf/tools/idf_monitor.py -p /dev/tty.usbserial-110 -b 115200 --toolchain-prefix "xtensa-esp32-elf-" --target esp32 --revision 0 /Users/zhangzhiyang/Documents/Code/goplus/llgo-esp32/independant-llgo-esp/test.elf